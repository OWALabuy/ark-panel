...
| Live compaction revision, usage, and fresh reload | `failed` | explicitly authorized isolated live probe | 显式 gate/四个 path 环境 + `npm run --silent test:compaction-live-probe -- <fixed arguments>` | 2026-08-22 | `f9f20d4` | `2026.6.11` | 一次真实 compact、零 send、effective tools 精确空且 constrained cleanup 完成；combined compact/usage validation 返回 `PROBE_USAGE_INVALID`，现有脱敏 envelope 不足以定位具体 conjunct，#21 保持 open | [2026-08-22 evidence](live-probe-results-2026-08-22.md#compaction-revision-and-usage-21) |
