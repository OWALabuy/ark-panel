...
| Live compaction revision, usage, and fresh reload | `failed` | explicitly authorized isolated live probe | 显式 gate/四个 path 环境 + `npm run --silent test:compaction-live-probe -- <fixed arguments>` | 2026-08-22 | `299e80a` | `2026.6.11` | 诊断复跑完成一次真实 provider/compact、零 send、effective tools 精确空且 constrained cleanup 完成；panel 未接受 candidate，固定返回 `PROBE_COMPACTION_NOT_ACCEPTED`，未产生可验收 revision/reload，#21 保持 open | [2026-08-22 evidence](live-probe-results-2026-08-22.md#compaction-revision-and-usage-21) |
